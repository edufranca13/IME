...
;;isso funciona porque o environment mantem as associações
;; dentro da mesma interpretação, em cada chamada de função é passado o mesmo environment
(interp (appC 'f1 (numC 3)) mt-env (list
